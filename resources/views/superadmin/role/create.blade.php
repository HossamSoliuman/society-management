        ...
        <div class="card-body">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="e.g. society_admin" value="{{ old('name') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="display_name" class="form-control {{ $errors->has('display_name') ? 'is-invalid' : '' }}" placeholder="e.g. Society Admin" value="{{ old('display_name') }}" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="3" placeholder="Enter role description...">{{ old('description') }}</textarea>
                </div>
                <div class="form-group">
