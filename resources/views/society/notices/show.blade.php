    ...
    <div class="page-header-row">
        <div>
            ...
            <div class="breadcrumb" style="margin-top: 6px;">
                ...
                <a href="{{ route('society.notices.index') }}">Notices</a>
                <span class="breadcrumb-separator">/</span>
                <span>{{ Str::limit($notice->title, 40) }}</span>
            </div>
        </div>
        <a href="{{ route('society.notices.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div style="display: flex; gap: 8px; margin-bottom: 16px; flex-wrap: wrap;">
                    ...
                    <span class="badge badge-info">{{ $notice->society_id ? $notice->society?->name : 'All societies' }}</span>
                </div>
